  ...
  return (
    ...
    >
      ...
      {/* <div className="fixed inset-0 -z-10">
        <Image
          src="/images/backgrounds/background2.jpeg"
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-32">
              <div className="mt-6 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-8">
                {DataStrings.projects.map((project) => {
                  return (
                    <div key={project.projectname} className="group relative ">
                          <div className="relative h-80 w-full overflow-hidden rounded-lg bg-white sm:aspect-h-1 sm:aspect-w-2 lg:aspect-h-1 lg:aspect-w-1 group">
                            ...
                            <a
                              ...
                              target="_blank"
                              className="absolute inset-0 flex items-center justify-center opacity-0 transition-opacity duration-300 group-hover:opacity-100 z-10"
                            >
                          ...
                          <h3 className="mt-6 mb-2 text-xl font-lemon">
                            <a
                              href={project.projectlink}
                              className="text-white textlink "
                            >
                              <span className="absolute inset-0" />
                              {project.projectname}
                            </a>
                          </h3>
                          <p className="text-sm font-light font-lemon text-white">{project.about}</p>
                        </div>
                  );
                })}
              </div>
